        ...
        html.Table([
            ...
            html.Tr([
                ...
                html.Td(dcc.Input(id='iAcc_log_amount',
                                  type='number', value='25', max='500')),
                html.Td([dcc.Dropdown(options=globalVariables.accountOptions, id='iAccount_Action'), html.Button(
                    'Provést akci', id="bAcc_Perform")])
                ])]),
        html.Div(id='account', children=AccountFun.getAccountHTML(calledAccount, 25) if calledAccount is not None else []),
        dcc.Interval(
